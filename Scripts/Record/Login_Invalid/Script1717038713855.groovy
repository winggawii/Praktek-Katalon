...
WebUI.setText(findTestObject('Object Repository/Record/input_Username_username'), 'Admin')

WebUI.setEncryptedText(findTestObject('Object Repository/Record/input_Password_password'), 'KMoFZeaWkJg=')
