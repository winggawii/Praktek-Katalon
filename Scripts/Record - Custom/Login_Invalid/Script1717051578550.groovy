...
WebUI.setText(findTestObject('Object Repository/Record/input_Username_username'), username)

WebUI.setText(findTestObject('Object Repository/Record/input_Password_password'), password)
